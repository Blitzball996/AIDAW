 ...
 *
 * Position read/write is in beats, consistent with the rest of AIDAW's
 * coordinate system. Implementations are responsible for the seconds-to-beats
 * conversion via the project's tempo sequence; callers don't see it.
 *
 * In headless / no-edit states queries return safe defaults (false, 0.0)
