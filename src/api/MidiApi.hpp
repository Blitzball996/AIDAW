...
/**
 * Outbound MIDI surface for scripts and agents — host to external device.
 *
 ...
 * to flow through MidiBridge / controller scripts as before.
 *
 * `port` accepts either the device's display name or its JUCE identifier —
 * implementations resolve both.
 */
class MidiApi {
  public:
