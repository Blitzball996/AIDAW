 ...
 * and writes.
 *
 * Lives behind DawApi so agents/scripting/CLI consumers don't depend on
...
class SelectionApi {
  public:
     ...
     *         INVALID_AUTOMATION_LANE_ID if no automation lane is selected.
     */
