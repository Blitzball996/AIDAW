...
aidaw::MidiBridge* DebugDialog::midiBridge_ = nullptr;
...
class DebugDialog::Content : public juce::Component, private juce::Timer {
  ...
  private:
    ...
    static juce::String formatMidiEvent(const aidaw::MidiEventEntry& entry) {
...
void DebugDialog::setMidiBridge(aidaw::MidiBridge* bridge) {
    midiBridge_ = bridge;
}
