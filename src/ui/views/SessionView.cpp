...
class SessionView::BeatBandContainer : public juce::Component {
  public:
    BeatBandContainer() {
        ...
        rateIcon_ = aidaw::ManagedDrawable::create(BinaryData::rate_svg, BinaryData::rate_svgSize);
        hideIcon_ = aidaw::ManagedDrawable::create(BinaryData::hide_svg, BinaryData::hide_svgSize);
  ...
  private:
    ...
    aidaw::ManagedDrawable rateIcon_;
    aidaw::ManagedDrawable hideIcon_;
};
  ...
  public:
    MiniChannelStrip(TrackId trackId, const TrackInfo& track) : trackId_(trackId) {
        ...
        volumeSlider_->onDragEnd = [this]() { multiTrackBaseVolumes_.clear(); };
        {
            ...
            volTarget.devicePath = aidaw::ChainNodePath::trackLevel(trackId_);
        ...
        panSlider_->onDragEnd = [this]() { multiTrackBasePans_.clear(); };
        {
            ...
            panTarget.devicePath = aidaw::ChainNodePath::trackLevel(trackId_);
