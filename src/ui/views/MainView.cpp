...
MainView::MainView(AudioEngine* audioEngine)
    ...
    aidaw::MidiLearnCoordinator::getInstance().attach(ControllerRouter::getInstance());
    aidaw::MidiLearnCoordinator::getInstance().setScope(
        static_cast<aidaw::BindingScope>(config.getMidiLearnDefaultScopeRaw()));
    ...
    aidaw::ProjectManager::getInstance().setAutoSaveEnabled(config.getAutoSaveEnabled(),
