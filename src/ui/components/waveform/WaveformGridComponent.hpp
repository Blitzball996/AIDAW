...
class WaveformGridComponent : public juce::Component {
  public:
     ...
     */
    void setDisplayInfo(const aidaw::ClipDisplayInfo& info);
    ...
    void setTimeRuler(aidaw::TimeRuler* ruler);
    ...
    void setWarpMarkers(const std::vector<aidaw::WarpMarkerInfo>& markers);
  ...
  private:
    aidaw::ClipId editingClipId_ = aidaw::INVALID_CLIP_ID;
    ...
    aidaw::ClipDisplayInfo displayInfo_{};  // Pre-computed display values
    ...
    std::vector<aidaw::WarpMarkerInfo> warpMarkers_;
    ...
    aidaw::TimeRuler* timeRuler_ = nullptr;  // not owned — reads tempo/timeSig + bar origin
    ...
    // Painting helpers
    void paintWaveform(juce::Graphics& g, const aidaw::ClipInfo& clip);
    WaveformLayout computeWaveformLayout(const aidaw::ClipInfo& clip) const;
    void paintWaveformBackground(juce::Graphics& g, const aidaw::ClipInfo& clip,
                                 const WaveformLayout& layout);
    void paintWaveformThumbnail(juce::Graphics& g, const aidaw::ClipInfo& clip,
                                const WaveformLayout& layout);
    void paintWaveformOverlays(juce::Graphics& g, const aidaw::ClipInfo& clip,
                               const WaveformLayout& layout);
    void paintBeatGrid(juce::Graphics& g, const aidaw::ClipInfo& clip);
    void paintWarpedWaveform(juce::Graphics& g, const aidaw::ClipInfo& clip,
                             juce::Rectangle<int> waveformRect, juce::Colour waveColour,
                             float vertZoom);
    void paintTransientMarkers(juce::Graphics& g, const aidaw::ClipInfo& clip);
    void paintWarpMarkers(juce::Graphics& g, const aidaw::ClipInfo& clip);
    ...
    // Hit testing helpers
    bool isNearLeftEdge(int x, const aidaw::ClipInfo& clip) const;
    bool isNearRightEdge(int x, const aidaw::ClipInfo& clip) const;
    bool isNearPhaseMarker(int x, const aidaw::ClipInfo& clip) const;
    bool isInsideWaveform(int x, const aidaw::ClipInfo& clip) const;
    ...
    // Get current clip
    const aidaw::ClipInfo* getClip() const;
