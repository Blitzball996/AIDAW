...
SvgButton::SvgButton(const juce::String& buttonName, const char* svgData, size_t svgDataSize)
    ...
    svgIcon = aidaw::ManagedDrawable::create(svgData, svgDataSize);
...
SvgButton::SvgButton(const juce::String& buttonName, const char* offSvgData, size_t offSvgDataSize,
    ...
    svgIconOff = aidaw::ManagedDrawable::create(offSvgData, offSvgDataSize);
    svgIconOn = aidaw::ManagedDrawable::create(onSvgData, onSvgDataSize);
