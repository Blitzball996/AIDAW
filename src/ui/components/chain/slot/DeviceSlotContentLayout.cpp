...
void showExpandedHeaderControls(const DeviceSlotTraits& traits, const aidaw::DeviceInfo& device,
...
bool prepareDeviceSlotContentFrame(juce::Rectangle<int>& contentArea,
                                   const DeviceSlotTraits& traits, const aidaw::DeviceInfo& device,
    ...
    if (collapsed || device.loadState != aidaw::DeviceLoadState::Loaded) {
