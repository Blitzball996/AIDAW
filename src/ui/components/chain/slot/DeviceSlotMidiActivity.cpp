...
void refreshSingleNoteStrip(daw::audio::ArpeggiatorPlugin* plugin, aidaw::MidiNoteStrip& strip,
                            int& lastNote) {
    if (plugin == nullptr)
        return;
...
void refreshSingleNoteStrip(daw::audio::StepSequencerPlugin* plugin, aidaw::MidiNoteStrip& strip,
                            int& lastNote) {
    if (plugin == nullptr)
        return;
...
void refreshChordStrip(daw::audio::MidiChordEnginePlugin* plugin, aidaw::MidiNoteStrip& strip,
