...
StepSequencerUI::StepSequencerUI() {
    ...
    // --- MIDI controls ---
    midiThruButton_ = std::make_unique<aidaw::SvgButton>("MidiThru", BinaryData::compare_svg,
    ...
    stepRecordButton_ = std::make_unique<aidaw::SvgButton>(
    ...
    randomButton_ = std::make_unique<aidaw::SvgButton>("Random", BinaryData::random_svg,
    ...
    // AI model indicator
    aiIcon_ =
        std::make_unique<aidaw::SvgButton>("AIIcon", BinaryData::ai_svg, BinaryData::ai_svgSize);
    ...
    aiClearButton_ = std::make_unique<aidaw::SvgButton>("ClearAIResult", BinaryData::delete_svg,
    ...
    auto cfg = aidaw::Config::getInstance().getAgentLLMConfig("music");
...
void StepSequencerUI::generateAIPattern() {
    ...
    std::thread([safeThis, prompt, systemPrompt, responseSchema, numSteps]() {
        auto agentConfig = aidaw::Config::getInstance().getAgentLLMConfig("music");
        auto client = aidaw::createLLMClient(agentConfig, "music");
...
std::vector<LinkableTextSlider*> StepSequencerUI::getLinkableSliders() {
    ...
    rateSlider_.setLinkContext(aidaw::INVALID_DEVICE_ID, 0, dummy);
    swingSlider_.setLinkContext(aidaw::INVALID_DEVICE_ID, 2, dummy);
    glideSlider_.setLinkContext(aidaw::INVALID_DEVICE_ID, 3, dummy);
    depthSlider_.setLinkContext(aidaw::INVALID_DEVICE_ID, 6, dummy);
    skewSlider_.setLinkContext(aidaw::INVALID_DEVICE_ID, 7, dummy);
