...
class FaustUI : public juce::Component {
  public:
    ...
    void setPlugin(aidaw::daw::audio::FaustPlugin* plugin);
  ...
  private:
    ...
    aidaw::daw::audio::FaustPlugin* plugin_ = nullptr;
    ...
    std::unique_ptr<aidaw::SvgButton> loadButton_;
    std::unique_ptr<aidaw::SvgButton> editButton_;
