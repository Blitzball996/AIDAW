...
FaustUI::FaustUI() {
    ...
    loadButton_ = std::make_unique<aidaw::SvgButton>("Load DSP", BinaryData::folderopen_svg,
    ...
    editButton_ = std::make_unique<aidaw::SvgButton>("Edit DSP", BinaryData::script_svg,
...
void FaustUI::setPlugin(aidaw::daw::audio::FaustPlugin* plugin) {
    plugin_ = plugin;
...
bool FaustUI::tryLoad(const juce::String& name, const juce::String& source,
                      aidaw::daw::audio::FaustCustomViewKind viewKind) {
...
void FaustUI::showLoadMenu() {
    ...
    juce::PopupMenu menu;
    auto starters = aidaw::daw::audio::getBundledStarterDsps();
    int id = 1;
    ...
    fileChooser_->launchAsync(
        ...
        [this](const juce::FileChooser& fc) {
            ...
            tryLoad(file.getFileNameWithoutExtension(), file.loadFileAsString(),
                    aidaw::daw::audio::FaustCustomViewKind::None);
        });
}
