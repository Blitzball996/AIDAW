...
void FourOscUI::updateFromParameters(const std::vector<aidaw::ParameterInfo>& params) {
...
void FourOscUI::OscTab::updateFromParameters(const std::vector<aidaw::ParameterInfo>& params) {
    for (int i = 0; i < 4; ++i) {
...
void FourOscUI::FilterTab::updateFromParameters(const std::vector<aidaw::ParameterInfo>& params) {
...
void FourOscUI::AmpTab::updateFromParameters(const std::vector<aidaw::ParameterInfo>& params) {
...
void FourOscUI::ModEnvTab::updateFromParameters(const std::vector<aidaw::ParameterInfo>& params) {
    for (int i = 0; i < 2; ++i) {
        int base = kModEnvBase + i * kModEnvParamsPerEnv;
...
void FourOscUI::LFOTab::updateFromParameters(const std::vector<aidaw::ParameterInfo>& params) {
    for (int i = 0; i < 2; ++i) {
        int base = kLfoBase + i * kLfoParamsPerLfo;
...
void FourOscUI::FXTab::updateFromParameters(const std::vector<aidaw::ParameterInfo>& params) {
