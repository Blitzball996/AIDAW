...
ImpulseResponseUI::ImpulseResponseUI() {
    ...
    loadButton_ = std::make_unique<aidaw::SvgButton>("Load IR", BinaryData::folderopen_svg,
...
void ImpulseResponseUI::updateFromParameters(const std::vector<aidaw::ParameterInfo>& params) {
    if (params.size() > 0)
