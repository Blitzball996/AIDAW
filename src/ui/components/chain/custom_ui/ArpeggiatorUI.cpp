...
std::vector<LinkableTextSlider*> ArpeggiatorUI::getLinkableSliders() {
    ...
    rateSlider_.setLinkContext(aidaw::INVALID_DEVICE_ID, 1, dummy);
    octavesSlider_.setLinkContext(aidaw::INVALID_DEVICE_ID, 2, dummy);
    gateSlider_.setLinkContext(aidaw::INVALID_DEVICE_ID, 3, dummy);
    swingSlider_.setLinkContext(aidaw::INVALID_DEVICE_ID, 4, dummy);
    depthSlider_.setLinkContext(aidaw::INVALID_DEVICE_ID, 5, dummy);
    skewSlider_.setLinkContext(aidaw::INVALID_DEVICE_ID, 6, dummy);
    fixedVelSlider_.setLinkContext(aidaw::INVALID_DEVICE_ID, 9, dummy);
