...
namespace aidaw::daw::ui::node_header {
...
inline void applyHeaderIconStyle(aidaw::SvgButton& btn, juce::Colour activeBg,
                                 bool toggling = true) {
