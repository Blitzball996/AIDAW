...
int maxPoolIndex(const aidaw::DeviceInfo& device) {
    int maxIdx = -1;
...
int FaustDeviceLayout::totalPages(const aidaw::DeviceInfo& device) const {
...
ParamCell FaustDeviceLayout::cellFor(const aidaw::DeviceInfo& device, int cellIndex,
