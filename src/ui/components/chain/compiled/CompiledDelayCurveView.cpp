...
void CompiledDelayCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaDelayCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledDelayCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledDelayCurveView::timerCallback() {
    using Delay = aidaw::daw::audio::compiled::MagdaDelayCompiledPlugin;
...
const CompiledPresentationSpec& getMagdaDelayPresentation() {
    ...
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaDelayCompiledPlugin::xmlTypeName,
        .layoutCellCount = 7,
        .layoutCellsPerRow = 7,
...
void CompiledDelayCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(dynamic_cast<aidaw::daw::audio::compiled::MagdaDelayCompiledPlugin*>(plugin));
}
