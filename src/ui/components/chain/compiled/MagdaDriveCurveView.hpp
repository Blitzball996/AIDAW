...
class MagdaDriveCurveView : public FaustCustomView, public juce::Timer {
  public:
    explicit MagdaDriveCurveView(aidaw::daw::audio::FaustPlugin& plugin);
  ...
  private:
    ...
    const aidaw::daw::audio::FaustParamSlot* findSlot(const juce::String& label) const;
    ...
    static float readSlotValue(const aidaw::daw::audio::FaustParamSlot* slot);

    aidaw::daw::audio::FaustPlugin& plugin_;
