...
void CompiledDimensionView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaDimensionCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledDimensionView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(
        dynamic_cast<aidaw::daw::audio::compiled::MagdaDimensionCompiledPlugin*>(plugin));
}

void CompiledDimensionView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
const CompiledPresentationSpec& getMagdaDimensionPresentation() {
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaDimensionCompiledPlugin::xmlTypeName,
        .layoutCellCount =
            aidaw::daw::audio::compiled::MagdaDimensionCompiledPlugin::kHostSlotCount,
        .layoutCellsPerRow = 6,
