...
class CompiledGrainDelayCurveView final : public juce::Component,
  ...
  public:
    ...
    void setCompiledPlugin(aidaw::daw::audio::compiled::MagdaGrainDelayCompiledPlugin* plugin);
  ...
  private:
    ...
    aidaw::daw::audio::compiled::MagdaGrainDelayCompiledPlugin* compiledPlugin_ = nullptr;
