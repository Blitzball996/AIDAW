...
void CompiledBitcrusherEditorView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaBitcrusherCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledBitcrusherEditorView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(
        dynamic_cast<aidaw::daw::audio::compiled::MagdaBitcrusherCompiledPlugin*>(plugin));
}

void CompiledBitcrusherEditorView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
const CompiledPresentationSpec& getMagdaBitcrusherPresentation() {
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaBitcrusherCompiledPlugin::xmlTypeName,
        .layoutCellCount =
            aidaw::daw::audio::compiled::MagdaBitcrusherCompiledPlugin::kHostSlotCount,
        .layoutCellsPerRow = 6,
