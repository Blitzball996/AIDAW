...
void CompiledReverbCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaReverbCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledReverbCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(
        dynamic_cast<aidaw::daw::audio::compiled::MagdaReverbCompiledPlugin*>(plugin));
}

void CompiledReverbCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledReverbCurveView::timerCallback() {
    using Rev = aidaw::daw::audio::compiled::MagdaReverbCompiledPlugin;
...
const CompiledPresentationSpec& getMagdaReverbPresentation() {
    ...
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaReverbCompiledPlugin::xmlTypeName,
        .layoutCellCount = 9,
        .layoutCellsPerRow = 9,
