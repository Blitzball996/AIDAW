...
class CompiledPitchEditorView final : public juce::Component,
  ...
  public:
    ...
    void setCompiledPlugin(aidaw::daw::audio::compiled::MagdaPitchCompiledPlugin* plugin);
  ...
  private:
    using Plugin = aidaw::daw::audio::compiled::MagdaPitchCompiledPlugin;

    void timerCallback() override;
    void resampleFromDevice();

    aidaw::daw::audio::compiled::MagdaPitchCompiledPlugin* compiledPlugin_ = nullptr;
