...
void CompiledCompressorCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaCompressorCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledCompressorCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledCompressorCurveView::timerCallback() {
    using Comp = aidaw::daw::audio::compiled::MagdaCompressorCompiledPlugin;
...
const CompiledPresentationSpec& getMagdaCompressorPresentation() {
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaCompressorCompiledPlugin::xmlTypeName,
        .layoutCellCount = 15,
        .layoutCellsPerRow = 6,
...
void CompiledCompressorCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(
        dynamic_cast<aidaw::daw::audio::compiled::MagdaCompressorCompiledPlugin*>(plugin));
}
