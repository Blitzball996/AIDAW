...
void CompiledFreqShiftCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaFreqShiftCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledFreqShiftCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(
        dynamic_cast<aidaw::daw::audio::compiled::MagdaFreqShiftCompiledPlugin*>(plugin));
}

void CompiledFreqShiftCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledFreqShiftCurveView::timerCallback() {
    using FS = aidaw::daw::audio::compiled::MagdaFreqShiftCompiledPlugin;
...
const CompiledPresentationSpec& getMagdaFreqShiftPresentation() {
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaFreqShiftCompiledPlugin::xmlTypeName,
        .layoutCellCount = 4,
        .layoutCellsPerRow = 4,
