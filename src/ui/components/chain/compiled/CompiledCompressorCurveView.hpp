...
class CompiledCompressorCurveView final : public juce::Component,
  ...
  public:
    ...
    void setCompiledPlugin(aidaw::daw::audio::compiled::MagdaCompressorCompiledPlugin* plugin);
  ...
  private:
    ...
    aidaw::daw::audio::compiled::MagdaCompressorCompiledPlugin* compiledPlugin_ = nullptr;
