...
class CompiledMultibandCurveView final : public juce::Component,
  ...
  public:
    ...
    void setCompiledPlugin(aidaw::daw::audio::compiled::MagdaMultibandCompiledPlugin* plugin);
  ...
  private:
    ...
    aidaw::daw::audio::compiled::MagdaMultibandCompiledPlugin* compiledPlugin_ = nullptr;
