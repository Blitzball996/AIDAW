...
void CompiledPitchEditorView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaPitchCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledPitchEditorView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(dynamic_cast<aidaw::daw::audio::compiled::MagdaPitchCompiledPlugin*>(plugin));
}

void CompiledPitchEditorView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
const CompiledPresentationSpec& getMagdaPitchPresentation() {
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaPitchCompiledPlugin::xmlTypeName,
        .layoutCellCount = aidaw::daw::audio::compiled::MagdaPitchCompiledPlugin::kHostSlotCount,
        .layoutCellsPerRow = 6,
