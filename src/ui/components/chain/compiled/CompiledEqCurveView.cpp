...
BiquadCoeffs makeBiquad(aidaw::daw::audio::compiled::MagdaEqCompiledPlugin::BandType type, float f0,
                        float gainDb, float q, float sampleRate) {
    using BandType = aidaw::daw::audio::compiled::MagdaEqCompiledPlugin::BandType;
...
const char* bandTypeShortName(aidaw::daw::audio::compiled::MagdaEqCompiledPlugin::BandType t) {
    using BandType = aidaw::daw::audio::compiled::MagdaEqCompiledPlugin::BandType;
    switch (t) {
        case BandType::Highpass:
            return "HP";
...
bool bandGainAffectsCurve(aidaw::daw::audio::compiled::MagdaEqCompiledPlugin::BandType t) {
    using BandType = aidaw::daw::audio::compiled::MagdaEqCompiledPlugin::BandType;
...
void CompiledEqCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaEqCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledEqCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(dynamic_cast<aidaw::daw::audio::compiled::MagdaEqCompiledPlugin*>(plugin));
}

void CompiledEqCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledEqCurveView::resampleFromDevice() {
    using Eq = aidaw::daw::audio::compiled::MagdaEqCompiledPlugin;
...
const CompiledPresentationSpec& getMagdaEqPresentation() {
    ...
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaEqCompiledPlugin::xmlTypeName,
        ...
        .layoutCellCount = aidaw::daw::audio::compiled::MagdaEqCompiledPlugin::kBandCount *
                           aidaw::daw::audio::compiled::MagdaEqCompiledPlugin::kSlotsPerBand,
        .layoutCellsPerRow = 8,
