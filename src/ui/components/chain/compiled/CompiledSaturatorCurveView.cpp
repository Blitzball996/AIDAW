...
void CompiledSaturatorCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaSaturatorCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledSaturatorCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledSaturatorCurveView::timerCallback() {
    using Sat = aidaw::daw::audio::compiled::MagdaSaturatorCompiledPlugin;
...
const CompiledPresentationSpec& getMagdaSaturatorPresentation() {
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaSaturatorCompiledPlugin::xmlTypeName,
        .layoutCellCount = 6,
        .layoutCellsPerRow = 6,
...
void CompiledSaturatorCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(
        dynamic_cast<aidaw::daw::audio::compiled::MagdaSaturatorCompiledPlugin*>(plugin));
}
