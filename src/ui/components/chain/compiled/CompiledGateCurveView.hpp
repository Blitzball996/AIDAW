...
class CompiledGateCurveView final : public juce::Component,
  ...
  public:
    ...
    void setCompiledPlugin(aidaw::daw::audio::compiled::MagdaGateExpanderCompiledPlugin* plugin);
  ...
  private:
    ...
    aidaw::daw::audio::compiled::MagdaGateExpanderCompiledPlugin* compiledPlugin_ = nullptr;
