...
class CompiledPhaserCurveView final : public juce::Component,
  ...
  public:
    ...
    void setCompiledPlugin(aidaw::daw::audio::compiled::MagdaPhaserCompiledPlugin* plugin);
  ...
  private:
    ...
    aidaw::daw::audio::compiled::MagdaPhaserCompiledPlugin* compiledPlugin_ = nullptr;
