...
void CompiledModCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaModCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledModCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(dynamic_cast<aidaw::daw::audio::compiled::MagdaModCompiledPlugin*>(plugin));
}

void CompiledModCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledModCurveView::timerCallback() {
    using Mod = aidaw::daw::audio::compiled::MagdaModCompiledPlugin;
    ...
    if (sync_) {
        if (compiledPlugin_ != nullptr) {
            const auto& info = compiledPlugin_->getSlotInfo(
                aidaw::daw::audio::compiled::MagdaModCompiledPlugin::kDivisionSlot);
...
const CompiledPresentationSpec& getMagdaModPresentation() {
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaModCompiledPlugin::xmlTypeName,
        .layoutCellCount = 6,
        .layoutCellsPerRow = 6,
