...
void CompiledGateCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaGateExpanderCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledGateCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledGateCurveView::timerCallback() {
    using Gate = aidaw::daw::audio::compiled::MagdaGateExpanderCompiledPlugin;
...
const CompiledPresentationSpec& getMagdaGatePresentation() {
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaGateExpanderCompiledPlugin::xmlTypeName,
        .layoutCellCount = 6,
        .layoutCellsPerRow = 3,
...
void CompiledGateCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(
        dynamic_cast<aidaw::daw::audio::compiled::MagdaGateExpanderCompiledPlugin*>(plugin));
}
