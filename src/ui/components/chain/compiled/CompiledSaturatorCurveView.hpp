...
class CompiledSaturatorCurveView final : public juce::Component,
  ...
  public:
    ...
    void setCompiledPlugin(aidaw::daw::audio::compiled::MagdaSaturatorCompiledPlugin* plugin);
  ...
  private:
    ...
    aidaw::daw::audio::compiled::MagdaSaturatorCompiledPlugin* compiledPlugin_ = nullptr;
