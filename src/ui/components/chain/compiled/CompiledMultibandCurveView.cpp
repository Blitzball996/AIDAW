...
void CompiledMultibandCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaMultibandCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledMultibandCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledMultibandCurveView::timerCallback() {
    using Mb = aidaw::daw::audio::compiled::MagdaMultibandCompiledPlugin;
...
const CompiledPresentationSpec& getMagdaMultibandPresentation() {
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaMultibandCompiledPlugin::xmlTypeName,
        .layoutCellCount = 12,
        .layoutCellsPerRow = 3,
...
void CompiledMultibandCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(
        dynamic_cast<aidaw::daw::audio::compiled::MagdaMultibandCompiledPlugin*>(plugin));
}
