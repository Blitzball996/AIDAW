...
class CompiledFlangerCurveView final : public juce::Component,
  ...
  public:
    ...
    void setCompiledPlugin(aidaw::daw::audio::compiled::MagdaFlangerCompiledPlugin* plugin);
  ...
  private:
    ...
    aidaw::daw::audio::compiled::MagdaFlangerCompiledPlugin* compiledPlugin_ = nullptr;
