...
class CompiledEqCurveView final : public juce::Component,
  ...
  public:
    ...
    void setCompiledPlugin(aidaw::daw::audio::compiled::MagdaEqCompiledPlugin* plugin);
  ...
  private:
    using Plugin = aidaw::daw::audio::compiled::MagdaEqCompiledPlugin;
    ...
    aidaw::daw::audio::compiled::MagdaEqCompiledPlugin* compiledPlugin_ = nullptr;
