...
class CompiledLimiterCurveView final : public juce::Component,
  ...
  public:
    ...
    void setCompiledPlugin(aidaw::daw::audio::compiled::MagdaLimiterCompiledPlugin* plugin);
  ...
  private:
    ...
    aidaw::daw::audio::compiled::MagdaLimiterCompiledPlugin* compiledPlugin_ = nullptr;
