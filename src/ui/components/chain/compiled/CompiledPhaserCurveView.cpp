...
void CompiledPhaserCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaPhaserCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledPhaserCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(
        dynamic_cast<aidaw::daw::audio::compiled::MagdaPhaserCompiledPlugin*>(plugin));
}

void CompiledPhaserCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledPhaserCurveView::timerCallback() {
    using Phaser = aidaw::daw::audio::compiled::MagdaPhaserCompiledPlugin;
...
const CompiledPresentationSpec& getMagdaPhaserPresentation() {
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaPhaserCompiledPlugin::xmlTypeName,
        .layoutCellCount = 7,
        .layoutCellsPerRow = 7,
