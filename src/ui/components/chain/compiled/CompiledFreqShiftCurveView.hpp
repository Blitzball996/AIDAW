...
class CompiledFreqShiftCurveView final : public juce::Component,
  ...
  public:
    ...
    void setCompiledPlugin(aidaw::daw::audio::compiled::MagdaFreqShiftCompiledPlugin* plugin);
  ...
  private:
    ...
    aidaw::daw::audio::compiled::MagdaFreqShiftCompiledPlugin* compiledPlugin_ = nullptr;
