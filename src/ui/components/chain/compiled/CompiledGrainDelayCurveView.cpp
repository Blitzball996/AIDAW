...
void CompiledGrainDelayCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaGrainDelayCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledGrainDelayCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledGrainDelayCurveView::timerCallback() {
    using GrainDelay = aidaw::daw::audio::compiled::MagdaGrainDelayCompiledPlugin;
...
const CompiledPresentationSpec& getMagdaGrainDelayPresentation() {
    ...
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaGrainDelayCompiledPlugin::xmlTypeName,
        .layoutCellCount = 8,
        .layoutCellsPerRow = 8,
...
void CompiledGrainDelayCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(
        dynamic_cast<aidaw::daw::audio::compiled::MagdaGrainDelayCompiledPlugin*>(plugin));
}
