...
void CompiledLimiterCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaLimiterCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledLimiterCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(
        dynamic_cast<aidaw::daw::audio::compiled::MagdaLimiterCompiledPlugin*>(plugin));
}

void CompiledLimiterCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledLimiterCurveView::timerCallback() {
    using Lim = aidaw::daw::audio::compiled::MagdaLimiterCompiledPlugin;
...
const CompiledPresentationSpec& getMagdaLimiterPresentation() {
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaLimiterCompiledPlugin::xmlTypeName,
        .layoutCellCount = 7,
        .layoutCellsPerRow = 7,
