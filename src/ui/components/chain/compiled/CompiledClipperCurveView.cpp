...
void CompiledClipperCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaClipperCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledClipperCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(
        dynamic_cast<aidaw::daw::audio::compiled::MagdaClipperCompiledPlugin*>(plugin));
}

void CompiledClipperCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledClipperCurveView::timerCallback() {
    using Clip = aidaw::daw::audio::compiled::MagdaClipperCompiledPlugin;
...
const CompiledPresentationSpec& getMagdaClipperPresentation() {
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaClipperCompiledPlugin::xmlTypeName,
        .layoutCellCount = 3,
        .layoutCellsPerRow = 3,
