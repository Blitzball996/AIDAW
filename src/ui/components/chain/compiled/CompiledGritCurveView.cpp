...
void CompiledGritCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaGritCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledGritCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledGritCurveView::timerCallback() {
    using Grit = aidaw::daw::audio::compiled::MagdaGritCompiledPlugin;
...
const CompiledPresentationSpec& getMagdaGritPresentation() {
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaGritCompiledPlugin::xmlTypeName,
        .layoutCellCount = 4,
        .layoutCellsPerRow = 4,
...
void CompiledGritCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(dynamic_cast<aidaw::daw::audio::compiled::MagdaGritCompiledPlugin*>(plugin));
}
