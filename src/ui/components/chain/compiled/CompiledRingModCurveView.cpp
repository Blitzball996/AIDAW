...
void CompiledRingModCurveView::setCompiledPlugin(
    aidaw::daw::audio::compiled::MagdaRingModCompiledPlugin* plugin) {
    compiledPlugin_ = plugin;
}

void CompiledRingModCurveView::bindPlugin(te::Plugin* plugin) {
    setCompiledPlugin(
        dynamic_cast<aidaw::daw::audio::compiled::MagdaRingModCompiledPlugin*>(plugin));
}

void CompiledRingModCurveView::updateFromDevice(const aidaw::DeviceInfo& device) {
...
void CompiledRingModCurveView::timerCallback() {
    using RM = aidaw::daw::audio::compiled::MagdaRingModCompiledPlugin;
...
const CompiledPresentationSpec& getMagdaRingModPresentation() {
    static const CompiledPresentationSpec kSpec{
        .pluginId = aidaw::daw::audio::compiled::MagdaRingModCompiledPlugin::xmlTypeName,
        .layoutCellCount = 7,
        .layoutCellsPerRow = 7,
