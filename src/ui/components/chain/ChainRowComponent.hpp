 ...
 */
class ChainRowComponent : public juce::Component, public aidaw::SelectionManagerListener {
  public:
    ChainRowComponent(RackComponent& owner, aidaw::TrackId trackId, aidaw::RackId rackId,
                      const aidaw::ChainInfo& chain);
    ...
    aidaw::ChainId getChainId() const {
        return chainId_;
    }
    aidaw::TrackId getTrackId() const {
        return trackId_;
    }
    ...
    void updateFromChain(const aidaw::ChainInfo& chain);
    ...
    // existed
    void setNodePath(const aidaw::ChainNodePath& path);
    ...
    std::function<void(aidaw::ChainId)> onDoubleClick;
  ...
  private:
    ...
    aidaw::ChainId chainId_;
    bool selected_ = false;
    aidaw::ChainNodePath nodePath_;  // For centralized selection

    // Single row controls: Name | Gain | Pan | M | S | On | X
    juce::Label nameLabel_;
    aidaw::DraggableValueLabel gainLabel_;
    aidaw::DraggableValueLabel panLabel_;
    juce::TextButton muteButton_;
    juce::TextButton soloButton_;
    std::unique_ptr<aidaw::SvgButton> onButton_;  // Bypass/enable toggle (power icon)
