...
class NodeComponent : public juce::Component,
                      public aidaw::SelectionManagerListener,
  ...
  public:
    ...
    virtual void setNodePath(const aidaw::ChainNodePath& path);
    const aidaw::ChainNodePath& getNodePath() const {
        return nodePath_;
    }
    ...
    void chainNodeReselected(const aidaw::ChainNodePath& path) override;
    ...
    void bindingRegistryChanged(aidaw::BindingScope) override {
  ...
  protected:
    ...
    virtual const aidaw::ModArray* getModsData() const {
        return nullptr;
    }
    virtual const aidaw::MacroArray* getMacrosData() const {
        return nullptr;
    }

    // Virtual methods for subclasses to provide available link targets
    virtual std::vector<std::pair<aidaw::DeviceId, juce::String>> getAvailableDevices() const {
        return {};
    }
    virtual std::map<aidaw::DeviceId, std::vector<juce::String>> getDeviceParamNames() const {
        return {};
    }

    // Virtual callbacks for mod/macro changes (subclasses implement to persist changes)
    virtual void onModTargetChangedInternal(int /*modIndex*/, aidaw::ControlTarget /*target*/) {}
    virtual void onModNameChangedInternal(int /*modIndex*/, const juce::String& /*name*/) {}
    virtual void onModTypeChangedInternal(int /*modIndex*/, aidaw::ModType /*type*/) {}
    virtual void onModWaveformChangedInternal(int /*modIndex*/, aidaw::LFOWaveform /*waveform*/) {}
    ...
    virtual void onModTriggerModeChangedInternal(int /*modIndex*/, aidaw::LFOTriggerMode /*mode*/) {
    }
    ...
    virtual void onModLinkAmountChangedInternal(int /*modIndex*/, aidaw::ControlTarget /*target*/,
                                                float /*amount*/) {}
    virtual void onModNewLinkCreatedInternal(int /*modIndex*/, aidaw::ControlTarget /*target*/,
                                             float /*amount*/) {}
    virtual void onModLinkRemovedInternal(int /*modIndex*/, aidaw::ControlTarget /*target*/) {}
    virtual void onMacroValueChangedInternal(int /*macroIndex*/, float /*value*/) {}
    virtual void onMacroTargetChangedInternal(int /*macroIndex*/, aidaw::ControlTarget /*target*/) {
    }
    ...
    virtual void onMacroLinkAmountChangedInternal(int /*macroIndex*/,
                                                  ...
                                                  float /*amount*/) {}
    virtual void onMacroNewLinkCreatedInternal(int /*macroIndex*/, aidaw::ControlTarget /*target*/,
                                               float /*amount*/) {}
    virtual void onMacroLinkRemovedInternal(int /*macroIndex*/, aidaw::ControlTarget /*target*/) {}
    ...
    virtual void onAddModRequestedInternal(int /*slotIndex*/, aidaw::ModType /*type*/,
  ...
  private:
    // Header controls
    std::unique_ptr<aidaw::SvgButton> bypassButton_;
