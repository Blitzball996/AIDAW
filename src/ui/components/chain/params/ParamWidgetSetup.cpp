...
void configureSliderFormatting(TextSlider& slider, const aidaw::ParameterInfo& info) {
    ...
    if (info.displayText) {
        ...
        const aidaw::ParameterInfo infoCopy = info;
        ...
        auto projectToTe = [provider, infoCopy, teMin, teSpan,
            ...
            if (infoMatchesTeRange && infoCopy.maxValue > infoCopy.minValue) {
                return aidaw::ParameterUtils::normalizedToReal(static_cast<float>(normalized),
                                                               infoCopy);
            }
        ...
        slider.setValueFormatter([provider, projectToTe, infoCopy](double real) {
            const float normalized =
                aidaw::ParameterUtils::realToNormalized(static_cast<float>(real), infoCopy);
        ...
        slider.setValueParser([provider, projectToTe,
            ...
            return static_cast<double>(
                aidaw::ParameterUtils::normalizedToReal(normalized, infoCopy));
        });
        return;
    }
...
void configureBoolToggle(juce::ToggleButton& toggle, const aidaw::ParameterInfo& info,
...
void configureDiscreteCombo(juce::ComboBox& combo, const aidaw::ParameterInfo& info,
                            std::function<void(double)> onValueChanged) {
