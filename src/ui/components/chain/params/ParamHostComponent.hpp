...
class ParamHostComponent : public juce::Component {
  public:
    ...
    void updateParameterSlots(const aidaw::DeviceInfo& device, int currentPage,
                              std::function<void(int paramIndex, double value)> onValueChanged);
    void updateParameterValues(const aidaw::DeviceInfo& device, int currentPage);

    void updateParamModulation(const aidaw::ModArray* mods, const aidaw::MacroArray* macros,
                               const aidaw::ModArray* rackMods, const aidaw::MacroArray* rackMacros,
                               const aidaw::ModArray* trackMods,
                               const aidaw::MacroArray* trackMacros, aidaw::DeviceId deviceId,
                               const aidaw::ChainNodePath& devicePath, int selectedModIndex,
    ...
    void refreshEnabledStates(const aidaw::DeviceInfo& device, int currentPage);
