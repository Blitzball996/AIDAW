...
class LFOCurveEditorContent : public juce::Component {
  public:
    LFOCurveEditorContent(aidaw::ModInfo* modInfo, std::function<void()> onWaveformChanged,
                          std::function<void()> onDragPreview);

    void resized() override;
    void paint(juce::Graphics& g) override;

    aidaw::LFOCurveEditor& getCurveEditor() {
        return curveEditor_;
    }
    ...
    std::function<void(aidaw::SyncDivision)> onSyncDivisionChanged;
    std::function<void(bool)> onOneShotChanged;
    std::function<void(bool)> onLoopRegionChanged;

  private:
    aidaw::ModInfo* modInfo_;
    aidaw::LFOCurveEditor curveEditor_;
    ...
    std::unique_ptr<aidaw::SvgButton> savePresetButton_;
...
class LFOCurveEditorWindow : public juce::DocumentWindow {
  public:
    LFOCurveEditorWindow(aidaw::ModInfo* modInfo, std::function<void()> onWaveformChanged,
