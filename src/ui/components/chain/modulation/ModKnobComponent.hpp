  ...
  public:
    ...
    void paint(juce::Graphics& g) override {
        ...
        for (int i = 0; i < numPoints; ++i) {
            ...
            float value = aidaw::ModulatorEngine::generateWaveformForMod(*mod_, phase);
 ...
 */
class ModKnobComponent : public juce::Component, public aidaw::LinkModeManagerListener {
  public:
    ...
    void setAvailableModifiers(
        const std::vector<std::pair<aidaw::ModId, juce::String>>& modifiers) {
  ...
  private:
    ...
    const aidaw::ModInfo* liveModPtr_ = nullptr;  // Pointer to live mod for animation
