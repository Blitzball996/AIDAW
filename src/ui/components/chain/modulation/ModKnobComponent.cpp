...
ModKnobComponent::ModKnobComponent(int modIndex) : modIndex_(modIndex) {
    ...
    currentMod_ = aidaw::ModInfo(modIndex);
...
void ModKnobComponent::setModInfo(const aidaw::ModInfo& mod, const aidaw::ModInfo* liveMod) {
    currentMod_ = mod;
    liveModPtr_ = liveMod;
...
void ModKnobComponent::paint(juce::Graphics& g) {
    ...
    bool isInLinkMode =
        aidaw::LinkModeManager::getInstance().isModInLinkMode(parentPath_, modIndex_);
...
void ModKnobComponent::modLinkModeChanged(bool active, const aidaw::ModSelection& selection) {
...
void ModKnobComponent::onLinkButtonClicked() {
    ...
    aidaw::LinkModeManager::getInstance().toggleModLinkMode(parentPath_, modIndex_);
}
...
void ModKnobComponent::onNameLabelEdited() {
    ...
    if (newName.isEmpty()) {
        ...
        newName = aidaw::ModInfo::getDefaultName(modIndex_, currentMod_.type);
