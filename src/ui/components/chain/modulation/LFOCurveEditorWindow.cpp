...
LFOCurveEditorContent::LFOCurveEditorContent(aidaw::ModInfo* modInfo,
...
void LFOCurveEditorContent::setupControls() {
    ...
    // Sync division combo
    syncDivisionCombo_.addItem("1 Bar", static_cast<int>(aidaw::SyncDivision::Whole) + 100);
    syncDivisionCombo_.addItem("1/2", static_cast<int>(aidaw::SyncDivision::Half) + 100);
    syncDivisionCombo_.addItem("1/4", static_cast<int>(aidaw::SyncDivision::Quarter) + 100);
    syncDivisionCombo_.addItem("1/8", static_cast<int>(aidaw::SyncDivision::Eighth) + 100);
    syncDivisionCombo_.addItem("1/16", static_cast<int>(aidaw::SyncDivision::Sixteenth) + 100);
    syncDivisionCombo_.addItem("1/32", static_cast<int>(aidaw::SyncDivision::ThirtySecond) + 100);
    syncDivisionCombo_.setSelectedId(static_cast<int>(aidaw::SyncDivision::Quarter) + 100,
    ...
    syncDivisionCombo_.onChange = [this]() {
        ...
        if (id >= 100) {
            auto division = static_cast<aidaw::SyncDivision>(id - 100);
            if (modInfo_) {
    ...
    // Preset selector
    presetCombo_.addItem("Triangle", static_cast<int>(aidaw::CurvePreset::Triangle) + 1);
    presetCombo_.addItem("Sine", static_cast<int>(aidaw::CurvePreset::Sine) + 1);
    presetCombo_.addItem("Ramp Up", static_cast<int>(aidaw::CurvePreset::RampUp) + 1);
    presetCombo_.addItem("Ramp Down", static_cast<int>(aidaw::CurvePreset::RampDown) + 1);
    presetCombo_.addItem("S-Curve", static_cast<int>(aidaw::CurvePreset::SCurve) + 1);
    presetCombo_.addItem("Exp", static_cast<int>(aidaw::CurvePreset::Exponential) + 1);
    presetCombo_.addItem("Log", static_cast<int>(aidaw::CurvePreset::Logarithmic) + 1);
...
LFOCurveEditorWindow::LFOCurveEditorWindow(aidaw::ModInfo* modInfo,
                                           std::function<void()> onWaveformChanged,
                                           std::function<void()> onDragPreview)
    ...
    content_.onSyncDivisionChanged = [this](aidaw::SyncDivision div) {
        if (onSyncDivisionChanged)
