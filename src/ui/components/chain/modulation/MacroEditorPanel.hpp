...
class MacroLinkMatrixContent : public juce::Component {
  public:
    ...
    std::function<void(aidaw::ControlTarget)> onDeleteLink;
    std::function<void(aidaw::ControlTarget, float)> onAmountChanged;
    std::function<void(aidaw::ControlTarget, bool)> onToggleBipolar;
...
class MacroEditorPanel : public juce::Component {
  public:
    ...
    void setParamNameResolver(
        std::function<juce::String(aidaw::DeviceId deviceId, int paramIndex)> resolver) {
    ...
    void setModNameResolver(
        std::function<juce::String(aidaw::ModId modId, int modParamIndex)> resolver) {
    ...
    std::function<void(aidaw::ControlTarget, float amount)> onLinkAmountChanged;
    std::function<void(aidaw::ControlTarget)> onLinkRemoved;
    std::function<void(aidaw::ControlTarget, bool bipolar)> onLinkBipolarToggled;
  ...
  private:
    ...
    std::function<juce::String(aidaw::ModId, int)> modNameResolver_;
