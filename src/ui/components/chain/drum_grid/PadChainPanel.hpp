...
class PadChainPanel : public juce::Component, public juce::DragAndDropTarget {
  public:
    ...
    struct PluginSlotInfo {
        ...
        aidaw::DeviceId deviceId =
            aidaw::INVALID_DEVICE_ID;  // MAGDA DeviceId for macro/mod linking
    ...
    void setLinkContext(const aidaw::ChainNodePath& devicePath, const aidaw::MacroArray* macros,
                        const aidaw::ModArray* mods, const aidaw::MacroArray* trackMacros,
  ...
  private:
    ...
    const aidaw::MacroArray* macros_ = nullptr;
    const aidaw::ModArray* mods_ = nullptr;
    const aidaw::MacroArray* trackMacros_ = nullptr;
    const aidaw::ModArray* trackMods_ = nullptr;
