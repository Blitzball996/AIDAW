...
DrumGridUI::PadButton::PadButton() {
    playButton_ = std::make_unique<aidaw::SvgButton>("Play", BinaryData::play_bare_svg,
...
DrumGridUI::DrumGridUI() {
    ...
    chainsToggleButton_ = std::make_unique<aidaw::SvgButton>("Chains", BinaryData::menu_svg,
