...
TrackHeadersPanel::TrackHeader::TrackHeader(const juce::String& trackName) : name(trackName) {
    ...
    muteButton->setLookAndFeel(&aidaw::daw::ui::SmallButtonLookAndFeel::getInstance());
    ...
    soloButton->setLookAndFeel(&aidaw::daw::ui::SmallButtonLookAndFeel::getInstance());
    ...
    recordButton->setLookAndFeel(&aidaw::daw::ui::SmallButtonLookAndFeel::getInstance());
    ...
    monitorButton->setLookAndFeel(&aidaw::daw::ui::SmallButtonLookAndFeel::getInstance());
...
void TrackHeadersPanel::showAutomationMenu(TrackId trackId, juce::Component* relativeTo) {
    ...
    // Track volume
    {
        ...
        tvTarget.devicePath = aidaw::ChainNodePath::trackLevel(trackId);
    ...
    // Track pan
    {
        ...
        tpTarget.devicePath = aidaw::ChainNodePath::trackLevel(trackId);
