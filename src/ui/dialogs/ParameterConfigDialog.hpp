...
struct MockParameterInfo {
    ...
    aidaw::ParameterScale scale = aidaw::ParameterScale::Linear;
...
class ParameterConfigDialog : public juce::Component,
  ...
  public:
    ...
    static bool applyConfigToDevice(const juce::String& uniqueId, aidaw::DeviceInfo& device);
  ...
  private:
    ...
    std::vector<aidaw::ParameterScanInput> scanInputs_;
    ...
    void runDetection();
    void applyDetectionResults(const std::vector<aidaw::DetectedParameterInfo>& results);
