...
class MediaExplorerContent : public PanelContent,
  ...
  private:
    ...
    std::unique_ptr<aidaw::SvgButton> audioFilterButton_;   // Center: Audio type filter
    std::unique_ptr<aidaw::SvgButton> midiFilterButton_;    // Center: MIDI type filter
    std::unique_ptr<aidaw::SvgButton> presetFilterButton_;  // Center: Preset type filter
    ...
    // Preview controls
    std::unique_ptr<aidaw::SvgButton> playButton_;
    std::unique_ptr<aidaw::SvgButton> stopButton_;
