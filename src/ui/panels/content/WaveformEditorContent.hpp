...
class WaveformEditorContent : public PanelContent,
                              ...
                              public aidaw::UndoManagerListener,
  ...
  public:
    ...
    aidaw::ClipId getEditingClipId() const {
  ...
  private:
    ...
    std::unique_ptr<aidaw::TimeRuler> timeRuler_;
    std::unique_ptr<aidaw::ZoomScrollBar> horizontalScrollBar_;
    ...
    aidaw::ClipDisplayInfo cachedDisplayInfo_{};  // Cached for playhead overlay positioning
    ...
    void updateDisplayInfo(const aidaw::ClipInfo& clip);

    // Warp marker helpers
    void refreshWarpMarkers();
    aidaw::AudioBridge* getBridge();
