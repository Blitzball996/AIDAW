...
juce::String PluginBrowserInfo::generateAlias(const juce::String& pluginName) {
    return aidaw::pluginNameToAlias(pluginName);
}
...
void PluginBrowserContent::setEngine(aidaw::TracktionEngineWrapper* engine) {
...
void PluginBrowserContent::showPluginContextMenu(const PluginBrowserInfo& plugin,
    ...
    bool hasTrack = trackManager.getSelectedTrack() != aidaw::INVALID_TRACK_ID;
        ...
        [this, plugin](int result) {
            ...
            switch (result) {
                case 1: {
                    ...
                    if (selectedTrack != aidaw::INVALID_TRACK_ID) {
...
juce::File PluginBrowserContent::getFavoritesFile() const {
    return aidaw::paths::pluginFavoritesFile();
}
...
juce::File PluginBrowserContent::getAliasesFile() const {
    return aidaw::paths::pluginAliasesFile();
}
