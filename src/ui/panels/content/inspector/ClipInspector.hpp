 ...
 */
class ClipInspector : public BaseInspector, public aidaw::ClipManagerListener {
  public:
    ClipInspector();
     ...
     */
    void setSelectedClip(aidaw::ClipId clipId);
  ...
  private:
    ...
    void initViewport();
    void updateAudioSourceValueDisplays(const aidaw::ClipInfo& clip);
    ...
    std::unique_ptr<aidaw::SvgButton> clipTypeIcon_;
    std::unique_ptr<aidaw::SvgButton> clipViewIcon_;

    // Position section
    juce::Label playbackColumnLabel_;
    juce::Label loopColumnLabel_;
    std::unique_ptr<aidaw::SvgButton> clipPositionIcon_;
    juce::Label clipStartLabel_;
    std::unique_ptr<aidaw::BarsBeatsTicksLabel> clipStartValue_;
    juce::Label clipEndLabel_;
    std::unique_ptr<aidaw::BarsBeatsTicksLabel> clipEndValue_;
    juce::Label clipLengthLabel_;
    std::unique_ptr<aidaw::BarsBeatsTicksLabel> clipLengthValue_;

    // Loop section
    std::unique_ptr<aidaw::SvgButton> clipLoopToggle_;
    juce::Label clipLoopStartLabel_;
    std::unique_ptr<aidaw::BarsBeatsTicksLabel> clipLoopStartValue_;
    juce::Label clipLoopEndLabel_;
    std::unique_ptr<aidaw::BarsBeatsTicksLabel> clipLoopEndValue_;
    juce::Label clipLoopPhaseLabel_;
    std::unique_ptr<aidaw::BarsBeatsTicksLabel> clipLoopPhaseValue_;
    ...
    std::unique_ptr<aidaw::DraggableValueLabel> clipStretchValue_;
    juce::ComboBox stretchModeCombo_;
    juce::Label clipBpmValue_;
    juce::Label clipBpmUnitLabel_;
    std::unique_ptr<aidaw::DraggableValueLabel> clipBeatsLengthValue_;
    ...
    std::unique_ptr<aidaw::DraggableValueLabel> grooveStrengthValue_;
    ...
    std::unique_ptr<aidaw::DraggableValueLabel> clipVolumeValue_;
    std::unique_ptr<aidaw::DraggableValueLabel> clipPanValue_;
    std::unique_ptr<aidaw::DraggableValueLabel> clipGainValue_;
    ...
    void updateLoopValueDisplays(const aidaw::ClipInfo& clip, double projectBPM, int beatsPerBar);
