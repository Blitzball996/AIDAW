...
void ClipInspector::setSelectedClips(const std::unordered_set<aidaw::ClipId>& clipIds) {
    selectedClipIds_ = clipIds;
    updateFromSelectedClip();
}

void ClipInspector::setSelectedClip(aidaw::ClipId clipId) {
...
void ClipInspector::clipPropertyChanged(aidaw::ClipId clipId) {
...
void ClipInspector::clipSelectionChanged(aidaw::ClipId clipId) {
