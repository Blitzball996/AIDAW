...
void DeviceInspector::setSelectedChainNode(const aidaw::ChainNodePath& path) {
...
void DeviceInspector::updateFromSelectedChainNode() {
    ...
    const aidaw::InternalDeviceMetadata* metadata = nullptr;
        ...
        switch (type) {
            ...
            case aidaw::ChainNodeType::TopLevelDevice: {
                ...
                if (device) {
                    ...
                    showLatency = true;
                    metadata = aidaw::getInternalDeviceMetadataForPluginId(device->pluginId);
                }
                break;
            }
