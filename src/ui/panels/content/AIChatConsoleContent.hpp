...
class AIChatConsoleContent : public PanelContent,
                             ...
                             public aidaw::ProjectManagerListener,
                             public aidaw::ConfigListener {
  public:
    ...
    void projectOpened(const aidaw::ProjectInfo& info) override;
  ...
  private:
    ...
    std::unique_ptr<aidaw::MagdaApiLive> ownedApi_;
    aidaw::MagdaApi* magdaApi_ = nullptr;

    std::unique_ptr<aidaw::DAWAgent> agent_;  // kept for legacy DSL REPL
    std::unique_ptr<aidaw::RouterAgent> routerAgent_;
    std::unique_ptr<aidaw::CommandAgent> commandAgent_;
    std::unique_ptr<aidaw::MusicAgent> musicAgent_;
    std::unique_ptr<aidaw::AutomationAgent> automationAgent_;
    std::unique_ptr<aidaw::ControllerProfileAgent> controllerAgent_;
    std::unique_ptr<aidaw::FourOscAgent> fourOscAgent_;
    ...
    std::unique_ptr<aidaw::SvgButton> serverToggleButton_;
    ...
    using SlashCommand = aidaw::daw::ui::SlashCommand;
    std::unique_ptr<aidaw::daw::ui::SlashCommandRegistry> slashRegistry_;
    ...
    std::unique_ptr<aidaw::SvgButton> aiTabButton_;
    std::unique_ptr<aidaw::SvgButton> dslTabButton_;
