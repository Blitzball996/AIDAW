...
class TrackChainContent : public PanelContent,
  ...
  public:
    ...
    void macroValueChanged(aidaw::TrackId trackId, aidaw::ChainScope scope, int ownerId,
    ...
    aidaw::TrackId getSelectedTrackId() const {
        return selectedTrackId_;
    }
    aidaw::RackId getSelectedRackId() const {
    ...
    // Add device commands
    void addDeviceToSelectedTrack(const aidaw::DeviceInfo& device);
    void addDeviceToSelectedChain(const aidaw::DeviceInfo& device);
  ...
  private:
    ...
    std::unique_ptr<aidaw::SvgButton> globalModsButton_;  // Toggle global modulators panel
    std::unique_ptr<aidaw::SvgButton> macroButton_;       // Toggle global macros panel
    std::unique_ptr<aidaw::SvgButton> addRackButton_;     // Add rack button
    std::unique_ptr<aidaw::SvgButton> treeViewButton_;    // Show chain tree dialog
    std::unique_ptr<aidaw::SvgButton> presetButton_;      // MAGDA track-chain presets menu
    ...
    aidaw::DraggableValueLabel volumeLabel_{aidaw::DraggableValueLabel::Format::Decibels};
    aidaw::DraggableValueLabel panLabel_{aidaw::DraggableValueLabel::Format::Pan};
    std::unique_ptr<aidaw::SvgButton> chainBypassButton_;  // On/off - bypasses entire track chain
    ...
    aidaw::RackId selectedRackId_ = aidaw::INVALID_RACK_ID;
    aidaw::ChainId selectedChainId_ = aidaw::INVALID_CHAIN_ID;

    // Custom look and feel for sliders
    aidaw::MixerLookAndFeel mixerLookAndFeel_;
    ...
    void onChainSelected(aidaw::TrackId trackId, aidaw::RackId rackId, aidaw::ChainId chainId);

    // Device selection management
    aidaw::DeviceId selectedDeviceId_ = aidaw::INVALID_DEVICE_ID;
    void onDeviceSlotSelected(aidaw::DeviceId deviceId);
    ...
    std::map<juce::String, aidaw::ChainId> savedExpandedChains_;  // rackPath -> expanded chainId
