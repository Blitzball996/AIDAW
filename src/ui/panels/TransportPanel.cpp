...
void TransportPanel::setupTempoAndQuantize() {
    ...
    autoGridButton->setLookAndFeel(&aidaw::daw::ui::SmallButtonLookAndFeel::getInstance());
    ...
    snapButton->setLookAndFeel(&aidaw::daw::ui::SmallButtonLookAndFeel::getInstance());
