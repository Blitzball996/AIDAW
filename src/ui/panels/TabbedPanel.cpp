...
void TabbedPanel::setupExpandButton() {
    ...
    expandButton_ = std::make_unique<aidaw::SvgButton>("Expand", svgData, svgSize);
...
void TabbedPanel::setAudioEngine(aidaw::AudioEngine* engine) {
    audioEngine_ = engine;
...
void TabbedPanel::setTimelineController(aidaw::TimelineController* controller) {
