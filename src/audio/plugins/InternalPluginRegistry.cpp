...
const InternalPluginSpec kSpecs[] = {
    ...
    {InternalDeviceKind::MidiReceive, ::aidaw::MidiReceivePlugin::xmlTypeName, "MIDI Receive",
     ...
     matches<::aidaw::MidiReceivePlugin>, nullptr},
    {InternalDeviceKind::SidechainMonitor, ::aidaw::SidechainMonitorPlugin::xmlTypeName,
     "Sidechain Monitor", "Utility", "Internal monitor used to expose sidechain signal state.",
     InternalPluginCreateMode::Unsupported, false, false, nullptr, 0,
     matches<::aidaw::SidechainMonitorPlugin>, nullptr},
    ...
    {InternalDeviceKind::SessionMonitor, ::aidaw::SessionMonitorPlugin::xmlTypeName,
     "Session Monitor", "Session", "Internal monitor used by session playback and launch state.",
     InternalPluginCreateMode::Unsupported, false, false, nullptr, 0,
     matches<::aidaw::SessionMonitorPlugin>, nullptr},
};
