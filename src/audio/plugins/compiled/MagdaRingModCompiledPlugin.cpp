...
void MagdaRingModCompiledPlugin::buildHostParameters() {
    ...
    hostSlotInfo_[kDivisionSlot].scale = aidaw::ParameterScale::Discrete;
    ...
    hostSlotInfo_[kShapeSlot].scale = aidaw::ParameterScale::Discrete;
    ...
    hostSlotInfo_[kSourceSlot].scale = aidaw::ParameterScale::Discrete;
