...
static std::unique_ptr<aidaw::TracktionEngineWrapper> g_engine;
...
bool magda_initialize() {
    ...
    try {
        ...
        g_engine = std::make_unique<aidaw::TracktionEngineWrapper>();
...
void magda_shutdown() {
    ...
    try {
        ...
        aidaw::LlamaModelManager::getInstance().unloadModel();
...
aidaw::TracktionEngineWrapper* magda_get_engine() {
    return g_engine.get();
}
